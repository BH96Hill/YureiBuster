...
public class MeshCut : MonoBehaviour
{
    ...
    public void Cut(Plane cutPlane)
    {
        ...
        GameObject obj = new GameObject("cut obj1", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(MeshCut));
        var mesh = new Mesh();
        ...
        obj.AddComponent<HitController>();
        ...
        GameObject obj2 = new GameObject("cut obj2", typeof(MeshFilter), typeof(MeshRenderer), typeof(MeshCollider), typeof(Rigidbody), typeof(MeshCut));
        var mesh2 = new Mesh();
        ...
        obj2.GetComponent<MeshCollider>().isTrigger = false;
        obj2.AddComponent<HitController>();
